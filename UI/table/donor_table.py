...
def donor_table_display():
    ...
    cursor.execute("SELECT aadhaar_id, gender, first_name, last_name, dob , mob, yob, blood_type, pregnancy_status, HIV, street, city, district, state, country, country_code, password, father_name, mother_name, gaurdian_name, ph1 , ph2 , hid from donor limit 0,10;")
